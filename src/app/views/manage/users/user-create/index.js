...
import { createMember } from 'src/features/agencySlice';
...
function CreateAgencyForm({ closeRef }) {
  ...
  const [initValue, setInitValue] = useState(new AgencyMember());
  ...
  const handleSubmit = data => {
    ...
    dispatch(createMember(newStaff));
        ...
        {({
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Grid item md={6} xs={12}>
              <InputLabel>Tên đăng nhập <span style={{ color: 'red' }}>*</span>: </InputLabel>
                <TextField
                  error={Boolean(
              ...
              <Grid item md={6} xs={12}>
                <InputLabel>Họ tên<span style={{ color: 'red' }}>*</span>: </InputLabel>
                <TextField
                  error={Boolean(
